...
import com.microservicesteam.adele.booking.domain.validator.PositionsValidator;
...
public class ReservationsService extends EventBasedService {
    ...
    public ReservationResponse reservePositions(List<Position> positions) {
        ...
        if (!validationResult.isValid()) {
            return com.microservicesteam.adele.booking.domain.ReservationRejected.fromValidationResult(validationResult);
        }
