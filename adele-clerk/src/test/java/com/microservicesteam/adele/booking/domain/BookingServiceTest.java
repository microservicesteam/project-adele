...
public class BookingServiceTest {
    ...
    public void setUp() throws Exception {
        ...
        bookingService = new BookingService(
                eventBus, validator, reservationIdGenerator, webSocketEventPublisher, ticketRepository);
        bookingService.init();
        ...
        when(reservationIdGenerator.generateReservationId()).thenReturn(BOOKING_ID);
    }
